...
RESOURCE_ATTRIBUTE_MAP: ResourceAttributeMap = {
    api_const.FIREWALL_RULES: {
        'id': {'allow_post': False, 'allow_put': False,
               ...
               'is_visible': True, 'is_filter': True, 'primary_key': True},
        ...
        'name': {'allow_post': True, 'allow_put': True,
                 ...
                 'is_visible': True, 'is_filter': True, 'default': ''},
        ...
        constants.SHARED: {
            ...
            'default': False, 'is_visible': True, 'is_filter': True,
            'convert_to': converters.convert_to_boolean,
            'required_by_policy': True, 'enforce_policy': True
        },
        'protocol': {
            'allow_post': True, 'allow_put': True,
            'is_visible': True, 'is_filter': True, 'default': None,
        ...
        'action': {'allow_post': True, 'allow_put': True,
                   ...
                   'is_visible': True, 'is_filter': True, 'default': 'deny'},
        'enabled': {'allow_post': True, 'allow_put': True,
                    'convert_to': converters.convert_to_boolean,
                    'default': True, 'is_visible': True, 'is_filter': True},
    },
