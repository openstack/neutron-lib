...
class FipPortForwardingDefinitionTestCase(base.DefinitionBaseTestCase):
    ...
    extension_attributes = (fip_pf.ID, fip_pf.PROJECT_ID, fip_pf.EXTERNAL_PORT,
                            fip_pf.INTERNAL_PORT, fip_pf.INTERNAL_IP_ADDRESS,
                            fip_pf.PROTOCOL, fip_pf.INTERNAL_PORT_ID,)
